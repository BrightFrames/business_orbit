 ...
 */
export function welcomeEmailTemplate(userName: string): { html: string; text: string; subject: string } {
 ...
 */
export function passwordResetConfirmationTemplate(userName: string): { html: string; text: string; subject: string } {
    const firstName = userName.split(' ')[0] || 'there';
 ...
 */
export function emailVerifiedTemplate(userName: string): { html: string; text: string; subject: string } {
    const firstName = userName.split(' ')[0] || 'there';
