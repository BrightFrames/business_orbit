 ...
 */
export function generateAvatarUrl(userId: number, gender: Gender): string {
 ...
 */
export function hasCustomProfilePhoto(user: {
    profile_photo_url?: string | null;
    profilePhotoUrl?: string | null;
}): boolean {
    const uploadedPhoto = user.profile_photo_url || user.profilePhotoUrl;
 ...
 */
export function generateAvatarForStorage(user: {
    id: number;
    profile_photo_url?: string | null;
    gender?: Gender;
}): string | null {
